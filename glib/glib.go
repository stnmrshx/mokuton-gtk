...
//separate free preventing double free >,<
func (v SList) Free1() {
...
// WrappedObject Section
type WrappedObject interface {
	GetInternalValue() unsafe.Pointer
}

// Events Section
// no need to pass optional data via void * pointer, nais :)
