...
// threads initialization for mutex runtime
func ThreadsInit() {
	C.gdk_threads_init()
}
...
// gdkSelection storing selection data
const (
...
// gdkCursor standard cursor and pixmap
type CursorType int //using int because fuckyou its int :)))
...
type EventProperty struct {
	// TODOLIST EventProperty
}

type EventProximity struct {
	// TODOLIST EventProximity
}

type EventClient struct {
	// TODOLIST EventClient
}

type EventNoExpose struct {
	// TODOLIST EventNoExpose
}

type EventWindowState struct {
	// TODOLIST EventWindowState
}

type EventSetting struct {
	// TODOLIST EventSetting
}

type EventOwnerChange struct {
	// TODOLIST EventOwnerChange
}

type EventGrabBroken struct {
	// TODOLIST EventGrabBroken
}
...
// gdkAtom for properties and atom, must uintptr
// Reference www.pygtk.org/docs/pygtk/class-gdkatom.html
type Atom uintptr
